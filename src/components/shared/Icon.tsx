...
const ICONS: Record<string, string> = {
  ...
  alert:   'M12 9v4M12 17h.01M10.3 3.5l-8 13.8A1 1 0 0 0 3.2 19h17.6a1 1 0 0 0 .87-1.5l-8-13.8a1 1 0 0 0-1.74 0z',
  shop:    'M3 6h18M3 6l2 14h14l2-14M9 6V4a3 3 0 0 1 6 0v2M10 11h4M12 9v6',
};
