...
export function SeoDashboardModule() {
  ...
  return (
    <div className="adm-content">
      ...
      <AdminAccordionStack>
        <AdminAccordion title="Indexation automatique">
          <div style={{ fontSize: 12.5, color: "var(--adm-ink-soft)", lineHeight: 1.6 }}>
        ...
        <AdminAccordion title="Indicateurs SEO">
        ...
        <AdminAccordion title="Produits à corriger">
