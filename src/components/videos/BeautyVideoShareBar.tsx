...
interface BeautyVideoShareBarProps {
  title: string;
  url: string;
}

export function BeautyVideoShareBar({ title, url }: BeautyVideoShareBarProps) {
  ...
  return (
    <div className="blog-share beauty-video-share" aria-label="Partager la vidéo">
