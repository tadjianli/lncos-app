  ...
  return (
    <div className="adm-content">
      ...
      <AdminAccordionStack>
        ...
        <AdminAccordion title="Dernières commandes">
          <div className="adm-card adm-list-card adm-card-scroll" style={{ border: "none", boxShadow: "none", padding: 0 }}>
            {!kpis ? (
        ...
        <AdminAccordion title="Derniers rendez-vous">
          <div className="adm-card adm-list-card adm-card-scroll" style={{ border: "none", boxShadow: "none", padding: 0 }}>
            {!kpis ? (
              <div style={{ padding: "30px 0", textAlign: "center", color: "var(--adm-ink-mute)", fontSize: 13 }}>Chargement…</div>
