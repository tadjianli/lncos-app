...
insert into public.home_sections (id, type, name, enabled, variant, title, subtitle, eyebrow, title_accent, cta, source, img, device, audience, position, is_draft) values
  ...
  ('trust-1',       'trust',      'Bandeau confiance',  true,  'pills',     'Bandeau confiance',                'Livraison 48h offerte|Vegan & cruelty-free|Formulé en France|+12 000 avis 4.9/5', 'truck|sparkle|heart|star', null,       null,        null,    null,        'all', 'all', 1,  false),
